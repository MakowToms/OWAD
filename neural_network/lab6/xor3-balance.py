...
plot_measure_results_data([mse_no_reg[10:], mse_reg_0001[10:], mse_reg_00001[10:], mse_reg_000001[10:]], labels=['no regularization', '-3', '-4', '-5'], title_base="accuracy", title_ending=" for " + str(i) + " layers networks")
