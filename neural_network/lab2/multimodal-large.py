...
# weights experiment
mse_zeros, zeros = learn_network(x, y, [20], [sigmoid, linear], initialize_weights='zeros', iterations=100, momentum_type='normal', plot=False, return_result=True)
mse_normal, normal = learn_network(x, y, [20], [sigmoid, linear], initialize_weights='norm', iterations=100, momentum_type='normal', plot=False, return_result=True)
mse_Xavier, Xavier = learn_network(x, y, [20], [sigmoid, linear], initialize_weights='Xavier', iterations=100, momentum_type='normal', plot=False, return_result=True)
...
mse_all, res_all = learn_network(x, y, [20], [sigmoid, linear], initialize_weights='Xavier', eta=0.00001, batch_size=10000, iterations=100, momentum_type='normal', plot=False, return_result=True)
