...
plt.subplot(222)
mse_linear = learn_network(x, y, [20, 20], [sigmoid, sigmoid, linear], iterations=1000, regression=False, plot_title='Predicted classes for linear function', plot_show=False)
plt.subplot(223)
mse_softmax = learn_network(x, y, [20, 20], [sigmoid, sigmoid, softmax], iterations=1000, regression=False, plot_title='Predicted classes for softmax function', plot_show=False)
